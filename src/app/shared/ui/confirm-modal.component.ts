...
@Component({
  ...
  template: `
    @if (open()) {
      ...
      <div class="cm__panel">
        <div class="cm__dialog" role="dialog" aria-modal="true" [attr.aria-label]="title()">
  ...
  styles: [`
    ...
    .cm__backdrop { position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 9999; }
    .cm__panel { position: fixed; inset: 0; display:flex; align-items:center; justify-content:center; padding: 16px; z-index: 10000; }
    .cm__dialog { background: #fff; color: #212529; border-radius: 16px; box-shadow: 0 8px 24px rgba(0,0,0,0.12); padding: 16px; min-width: 300px; max-width: 90vw; }
    .cm__title { font-weight: 700; margin-bottom: 8px; }
    .cm__message { color: rgba(33, 37, 41, 0.6); margin-bottom: 12px; }
